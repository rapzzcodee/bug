...
<head>
  ...
  <title>LueCrash - Dashboard</title>
...
<body>
  ...
  <div class="sidebar" id="sidebar">
    <div class="sidebar-header">
      <div class="logo-container">
        ...
        <img src="https://i.top4top.io/p_3590b6bk90.jpg" class="logo" alt="LueCrash Logo">
      </div>
      <div class="app-title">LueCrash</div>
  ...
  <source src="https://assets.codepen.io/3364143/710.mp4" type="video/mp4">
      ...
      <div class="banner-content">
        <div class="banner-title">LueCrash</div>
...
app.get("/ngl-spam/guide", requireAuth, (req, res) => {
  ...
  <head>
      <meta charset="UTF-8">
      <meta name="viewport" content="width=device-width, initial-scale=1.0">
      <title>Panduan NGL Spam - LueCrash</title>
      <link href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.0/css/all.min.css" rel="stylesheet">
      <link href="https://fonts.googleapis.com/css2?family=Orbitron:wght@600;800&family=Poppins:wght@300;400;500;600;700&display=swap" rel="stylesheet">
      <style>
        :root {
  ...
  <div class="main-content">
      ...
      <div class="bug-selector-container">
        ...
        <div class="selected-bug-display" id="selectedBugDisplay">
          <div class="terminal-line">
            <span class="terminal-prompt">user@LueCrash:~$</span>
    ...
    <div class="info-section">
      ...
      <div class="info-content">
        ...
        <p>LueCrash menggunakan protokol keamanan tingkat tinggi untuk melindungi identitas dan data pengguna:</p>
